...
export default function SectionFaq({ faq, section }: Props) {
  return (
    <section class="flex w-full h-full items-center justify-center bg-pale-gray text-black">
      <div class="flex flex-col items-center justify-center w-full xl:max-w-5xl px-6 md:py-32 md:px-0">
        <Faq {...faq} />

        <div class="flex items-center justify-center w-full px-0 sm:px-24 xl:px-0">
          {section && (
            <Section
              title={section.title}
              label={section.label}
