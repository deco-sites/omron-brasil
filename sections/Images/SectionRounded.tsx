...
export default function SectionRounded({ title, description, buttonTitle, backgroundImage, imageAlt }: SectionRoundedProps) {
  return (
    <div class="flex items-center justify-center w-full h-full my-4 mt-20">
      <div class="grid md:grid-cols-2 gap-x-2 gap-y-8 w-full h-full min-h-[410px] max-w-3xl xl:max-w-6xl bg-[#E5E5E5] md:rounded-[52px]">
        <div class="order-2 md:order-1 flex flex-col gap-1 items-start justify-center px-6 pb-16 md:px-0 md:pb-0 md:pl-12">
          ...
          <p class="text-black text-normal pt-3 text-normal pb-4">{description}</p>
