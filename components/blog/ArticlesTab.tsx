              ...
              {articles?.map((article) => (
                <div class="flex flex-col w-full">
                  <button
                    ...
                    class={`${
                      selectedArticle === article && 'border-[#005EB8] border-b font-bold'
        ...
        {selectedArticle && (
          <div class="flex flex-col gap-10 w-full h-full">
            <div class="hidden lg:flex items-end justify-between w-full">
              <p class="leading-7 text-xl max-w-4xl">{selectedArticle.description}</p>
              {selectedArticle.hasButton && (
                <button
                  className="border-black bg-transparent text-black hover:bg-[#003153] hover:text-white btn rounded-xl w-full max-w-[190px]"
                >
