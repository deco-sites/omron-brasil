  ...
  return (
    <div class="flex flex-col lg:flex-row items-start justify-center gap-8 w-full h-full">
      ...
      <div class="flex flex-col h-full w-full gap-2">
        {paragraphs?.map((item) => <p class="text-base">{item}</p>)}
      </div>
    </div>
  );
}
      ...
      <div class="flex flex-col w-full h-full items-start text-start gap-11">
        <div class="flex flex-col gap-4">
          ...
          <p>
            ...
            Doctors call this a hypertensive crisis, and it requires immediate
            treatment. Call your closest medical centre to understand what steps
            you need to follow to get the treatment you need.
          </p>
        ...
        <p>
          To check your blood pressure against the chart, start from your
          systolic pressure on the left-hand side, and move your finger to the
          right until you reach your diastolic pressure. The colour will tell
          you whether you have normal or abnormal blood pressure.
        </p>
      </div>
    </div>
  );
